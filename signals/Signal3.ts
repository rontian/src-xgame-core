...
export class Signal3<T1, T2, T3> extends SignalBase {
    public dispatch(o1: T1, o2: T2, o3: T3): void {
        ...
        for (node = this.head; node; node = node.next) {
            const cancel = node.execute(o1, o2, o3);
            if (node.once) {
    ...
    public add(listener: (o1: T1, o2: T2, o3: T3) => void, thisObject: any = null, priority = 0): void {
        super.add(listener, thisObject, priority);
    }

    public addOnce(listener: (o1: T1, o2: T2, o3: T3) => void, thisObject: any = null, priority = 0): void {
